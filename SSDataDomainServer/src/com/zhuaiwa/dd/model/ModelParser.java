...
//		}
		...
		for (Field field: clazz.getDeclaredFields()) {
			...
			com.zhuaiwa.dd.annotation.Column columnAnotation = null;
			if ((columnAnotation = field.getAnnotation(com.zhuaiwa.dd.annotation.Column.class)) != null) {
			...
			com.zhuaiwa.dd.annotation.SuperColumn superColumnAnotation = null;
			if ((superColumnAnotation = field.getAnnotation(com.zhuaiwa.dd.annotation.SuperColumn.class)) != null) {
				if (model.getModelType() == null)
			...
			com.zhuaiwa.dd.annotation.Columns columnsAnotation = null;
			if ((columnsAnotation = field.getAnnotation(com.zhuaiwa.dd.annotation.Columns.class)) != null) {
			...
			com.zhuaiwa.dd.annotation.SuperColumns supercolumnsAnotation = null;
			if ((supercolumnsAnotation = field.getAnnotation(com.zhuaiwa.dd.annotation.SuperColumns.class)) != null) {
				assert(model.getModelType() == null);
				assert(model.getValueType() == null);
