...
public class AccountDao extends AbstractDao<Account> {
    ...
    public static void build(Account account, String id, ColumnSlice<String, ByteBuffer> slices) {
        ...
        build(account, id, columns);
    }
    public static void build(Account account, String id, List<HColumn<String, ByteBuffer>> columns) {
        Iterator<HColumn<String, ByteBuffer>> i = (columns != null ? columns.iterator() : null);
        build(account, id, i);
    }
    public static void build(Account account, String id, Iterator<HColumn<String, ByteBuffer>> columns) {
        if (columns != null) {
