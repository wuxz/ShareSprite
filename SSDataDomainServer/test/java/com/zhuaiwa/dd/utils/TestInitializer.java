...
public class TestInitializer {
    ...
    private static class EmbeddedHolder {
        private static final EmbeddedCassandraServer embedded;
        static {
    ...
    private static class Singleton {
        ...
        static {
            if (EmbeddedHolder.embedded == null);
            // repair executor
            ...
            SSDataDomainSvcImpl impl = new SSDataDomainSvcImpl();
    ...
    public static void shutdown() {
        EmbeddedHolder.embedded.teardown();
    }
}
