...
public class CassandraUtils {
    ...
    public static ByteBuffer guidAsBytes()
    {
        ...
        return ByteBuffer.wrap(localMD5Digest.get().digest(valueBeforeMD5.getBytes()));
    }
    ...
    */
    ...
    public String key2token(ByteBuffer key)
    {
        if (key.remaining() == 0)
            return new BigInteger("-1").toString();
        return hashToBigInteger(key).toString();
    }
}
