 ...
 * under the License.
 */
package com.zhuaiwa.api.netty.ssl;
 ...
 * created by this factory sends a bogus certificate defined in {@link NettyRpcKeyStore}.
 * <p>
 ...
 */
public class NettyRpcSslContextFactory {
    ...
    static {
        ...
        try {
            ...
            ks.load(NettyRpcKeyStore.asInputStream(),
                    NettyRpcKeyStore.getKeyStorePassword());

            // Set up key manager factory to use our key store
            KeyManagerFactory kmf = KeyManagerFactory.getInstance(algorithm);
            kmf.init(ks, NettyRpcKeyStore.getCertificatePassword());
        ...
        try {
            ...
            clientContext.init(null, NettyRpcTrustManagerFactory.getTrustManagers(), null);
        } catch (Exception e) {
            throw new Error(
