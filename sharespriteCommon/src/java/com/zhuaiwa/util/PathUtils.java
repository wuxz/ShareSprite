...
public class PathUtils {
	 ...
	 * 在程序中很难定位某个相对路径，特别是在B/S应用中。通过这个方法，我们可以根据我们
	 * 程序自身的类文件的位置来定位某个相对路径。
	 * 
	 * 比如：某个txt文件相对于程序的Test类文件的路径是../../resource/test.txt，那
	 * 么使用本方法getFullPathRelateClass("../../resource/test.txt", Test.class)
